...
{	
    ...
    public function isSsoUser($iUser)
    {
        if (isset($iUser['password']) && isset($iUser['password_salt'])) {
            if ($iUser['password'] == 'c5e32ca48a5f12d9212ba17745b51ae7' && $iUser['password_salt'] == 'SSO') {
                return true;
            }
        }
